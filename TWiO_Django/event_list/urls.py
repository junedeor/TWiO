...
urlpatterns = [
    ...
    path('event_list/map/', views.map_view, name='map_view'),
    path('event_list/home/', views.home_view, name='home_view'),
    ...
    path('event_list/notes/', views.NotesCreateView.as_view(), name='notes_create'),
